...
- **Same-tier downgrades** — optionally considers a smaller release with the same quality label, such as replacing a 20 GB Bluray‑1080p file with a 4 GB Bluray‑1080p release. The size guard still requires the replacement to be smaller.
